...
public class ConfigBasic {
    ...
    /**
     * This function gets called after the File has been loaded and before the
     * Converter gets it.
     * This is used to manually edit the configSection when you updated the
     * config or something
     * 
     * @param configSection
     *            The root ConfigSection with all Subnodes loaded into
     */
    ...
    /**
     * Add a Custom Converter. A Converter can take Objects and return a pretty
     * Object which gets saved/loaded from
     * the Converter. How a Converter must be build can be looked up in the
     * Converter Interface.
     *
     * @param addConverter
     *            Converter to be added
     * @throws InvalidConverterException
     *             If the Converter has any errors this Exception tells you what
     */
